...
public class ImgSwiperAdapterProDetailBuyer extends PagerAdapter {

    private ViewBuyerProDetailActivity _activity;
    ...
    public ImgSwiperAdapterProDetailBuyer(ViewBuyerProDetailActivity activity,
