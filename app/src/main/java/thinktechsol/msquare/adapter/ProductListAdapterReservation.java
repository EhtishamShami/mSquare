 ...
 */
public class ProductListAdapterReservation extends ArrayAdapter<BuyerReservationListModel> {
    ...
    BuyerReservationActivityProduct ActivityContext;

    LayoutInflater inflater = (LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    Context context;
    private ArrayList<BuyerReservationListModel> list;


    public ProductListAdapterReservation(Context context, BuyerReservationActivityProduct ActivityContext, int textViewResourceId, ArrayList<BuyerReservationListModel> list) {
            ...
            switch (viewType) {
                case _row:
                    ...
                    if (v == null) {
                        ...
                        v = vi.inflate(R.layout.product_list_adapter_item_reservation, parent, false);

                        holder = new ViewHolder();

                        holder.proTitle = (TextView) v.findViewById(R.id.proTitle);
                        holder.proPrice = (TextView) v.findViewById(R.id.proPrice);
                        holder.proQuantity = (TextView) v.findViewById(R.id.proQuantity);

                        v.setTag(holder);
                    } else {
                        holder = (ViewHolder) v.getTag();
                    }
                    final BuyerReservationListModel myItem = list.get(position);
                    ...
                    if (myItem.proTitle != null)
                        holder.proTitle.setText("" + myItem.proTitle);

                    if (myItem.proPrice != null)
                        holder.proPrice.setText("" + myItem.proPrice);

                    if (myItem.proQuantity != null)
                        holder.proQuantity.setText("" + myItem.proQuantity);
