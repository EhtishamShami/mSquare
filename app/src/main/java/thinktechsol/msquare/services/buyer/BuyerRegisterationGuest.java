...
import thinktechsol.msquare.activities.buyer.BuyerRegisterationActivityGuest;
...
public class BuyerRegisterationGuest {
    ...
    BuyerRegisterationActivityGuest ref;
    ArrayList<String> selectedImagePath;
    RegisterRequestModel requestModel;

    String productDetails[];

    public BuyerRegisterationGuest(final Context ctx, BuyerRegisterationActivityGuest ref, RegisterRequestModel requestModel) {
        this.ctx = ctx;
        this.ref = ref;
