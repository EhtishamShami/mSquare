...
public class GetBuyerDetails2 {
    ...
    public GetBuyerDetails2(final Context ctx, String buyerId) {
        this.ctx = ctx;
        this.ref = ref;
...
//                Log.e(TAG, "getServiceSellers list pr1212o" + list.size());
                ...
                globels.getGlobelRef().buyerEmailId = BuyerDetails.get(0).email;

                globels.getGlobelRef().houseNo = BuyerDetails.get(0).houseNo;
                globels.getGlobelRef().streetNo = BuyerDetails.get(0).streetNo;
                globels.getGlobelRef().area = BuyerDetails.get(0).area;
