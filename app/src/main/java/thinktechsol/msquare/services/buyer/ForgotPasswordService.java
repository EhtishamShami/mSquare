...
public class ForgotPasswordService {
    ...
    public ForgotPasswordService(final Context ctx, BuyerLoginActivity ref, String email) {
        this.ctx = ctx;
        this.ref = ref;
...
//                Log.e(TAG, "getServiceSellers list pr1212o" + list.size());
                ...
                Toast.makeText(ctx, "Password send to email address arshad@gmail.com", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
