...
public class BuyerAddRatingService {

    private static final String TAG = "BuyerAddRatingService";

    String _url = "addRating/";
    Context ctx;
    ProgressDialog progressDialog;
    AlertDialog NotFoundDialog;
    ViewBuyerProDetailActivity ref;
    String sellerId, buyerId, serviceId, productId, stars;
    String productDetails[];

    public BuyerAddRatingService(final Context ctx, String sellerId, String buyerId, String serviceId, String productId, String stars) {
        this.ctx = ctx;
        this.ref = ref;
    ...
    private ArrayList<RegisterModel> returnParsedJsonObject(String result) {
        ...
        try {
            ...
            Log.e(TAG, "addRating childJSonObj=" + childJSonObj);
     ...
     */
    class addRatingService extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... input) {
            try {
                ...
                Log.e(TAG, " addRating url is=" + url);
...
//                httpURLConnection.setDoInput(true);
                ...
                Log.e(TAG, "addRating result=" + httpURLConnection.getResponseMessage());
        ...
        protected void onPostExecute(String response) {
            if (response != null) {
                ...
                Log.e(TAG, "addRating list response is=" + response);
                progressDialog.dismiss();
//                ref.addToWishListServiceResponse(list);
                Toast.makeText(ctx, "Rating Submited", Toast.LENGTH_SHORT).show();
