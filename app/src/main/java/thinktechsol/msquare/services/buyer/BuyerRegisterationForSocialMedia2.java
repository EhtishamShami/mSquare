...
public class BuyerRegisterationForSocialMedia2 {
    ...
    public BuyerRegisterationForSocialMedia2(final Context ctx, BuyerLoginActivityGuest ref, RegisterRequestModel requestModel) {
        this.ctx = ctx;
        this.ref = ref;
