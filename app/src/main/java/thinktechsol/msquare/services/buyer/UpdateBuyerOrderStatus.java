...
public class UpdateBuyerOrderStatus {
    ...
    public UpdateBuyerOrderStatus(final Context ctx, BuyerOrdersActivity ref, String orderId, String OrderStatus, int selectedListPosition) {
        this.ctx = ctx;
        this.ref = ref;
