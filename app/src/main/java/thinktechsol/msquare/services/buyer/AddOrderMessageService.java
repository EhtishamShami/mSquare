...
public class AddOrderMessageService {

    private static final String TAG = "AddOrderMessage";

    String _url = "addOrderMessage";
    Context ctx;
    ...
    String orderId, messageType, text;

    String productDetails[];

    public AddOrderMessageService(final Context ctx, ViewSellOrderDetailActivity ref, String orderId, String messageType, String text) {
        this.ctx = ctx;
        this.ref = ref;
    ...
    private ArrayList<RegisterModel> returnParsedJsonObject(String result) {
        ...
        try {
            ...
            if (response.equals("true")) {
                ...
                Log.e(TAG, "AddOrderMessage childJSonObj=" + childJSonObj);
     ...
     */
    class addOrderMessages extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... input) {
            try {
                ...
                Log.e(TAG, "AddOrderMessage url is=" + url);
...
//                Log.e("sellerLogIn", "input data is=" + globels.getGlobelRef().sellerlogin.id + " , " + globels.getGlobelRef().IdForAddProduct + " , " + productDetails[0] + " , " + productDetails[1] + " , " + productDetails[2] + " , " + productDetails[3]);
                ...
                String post_data = URLEncoder.encode("orderId", "UTF-8") + "=" + URLEncoder.encode(orderId, "UTF-8")
                        + "&" + URLEncoder.encode("sender", "UTF-8") + "=" + URLEncoder.encode(messageType, "UTF-8")
                        + "&" + URLEncoder.encode("messageBody", "UTF-8") + "=" + URLEncoder.encode(text, "UTF-8");

                bufferedWriter.write(post_data);
                bufferedWriter.close();
                outputStream.close();

                Log.e(TAG, "AddOrderMessage list result=" + httpURLConnection.getResponseMessage());
        ...
        protected void onPostExecute(String response) {
            if (response != null) {
                ...
                Log.e(TAG, "AddOrderMessage list response is=" + response);
                progressDialog.dismiss();
