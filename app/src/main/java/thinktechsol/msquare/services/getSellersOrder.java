...
public class getSellersOrder {

    private static final String TAG_SUCCESS = "success";

    String _url = "getSellerOrders/";
    Context ctx;
    ...
    public getSellersOrder(final Context ctx, SellersOrdersActivity ref, String sellerId, String orderType) {
        this.ctx = ctx;
        this.ref = ref;
        ...
        new getSellerOrdersAsync().execute("0");
    }


    private ArrayList<GetSellerOrdersModel> returnParsedJsonObject(String result) {

        JSONObject resultObject = null;
        JSONArray jsonArray = null;
        ArrayList<GetSellerOrdersModel> sellerOrdersList = new ArrayList<GetSellerOrdersModel>();
...
//          getting product details start
     ...
     */
    class getSellerOrdersAsync extends AsyncTask<String, String, String> {
...
//                URL url = new URL(Constant.baseUrl + _url + sellerServiceId + "/" + serviceSellerId + "/" + latitude + "/" + longitude);
                URL url = new URL(Constant.baseUrl + _url + sellerId + "/" + orderType);
        ...
        protected void onPostExecute(String response) {
            if (response != null) {
                ArrayList<GetSellerOrdersModel> list = returnParsedJsonObject(response);
