...
public class getConversationListSeller {

    private static final String TAG_SUCCESS = "success";

    String _url = "getConversationListSeller/";
    Context ctx;
    ProgressDialog progressDialog;
    AlertDialog NotFoundDialog;
    SellerDashBoardMessageFragment ref;
    private static final String TAG = "getConversationList";

    //    globels.getGlobelRef().sellerlogin.id
    public getConversationListSeller(final Context ctx, SellerDashBoardMessageFragment ref) {
        this.ctx = ctx;
        this.ref = ref;
