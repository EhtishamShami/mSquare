...
public class AddSellerStaffService {

    private static final String TAG_SUCCESS = "success";

    String _url = "addStaff/";
    Context ctx;
    ...
    public AddSellerStaffService(final Context ctx, SellerViewStaffActivity ref, String sellerId, String name) {
        this.ctx = ctx;
        this.ref = ref;
    ...
    class AddStaffDetail extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... input) {
            try {
                ...
                Log.e(TAG, "AddStaffDetail url=" + url);
        ...
        protected void onPostExecute(String response) {
            Log.e(TAG, "AddStaffDetail list PostExec" + response);
            if (response != null && response.contains("Successfull")) {
