...
import thinktechsol.msquare.services.buyer.BuyerRegisterationGuest;
import thinktechsol.msquare.services.buyer.UpdateDeviceInfoService;
import thinktechsol.msquare.utils.Constant;

public class BuyerRegisterationActivityGuest extends Activity {
        ...
        btn_registration.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View arg0, MotionEvent arg1) {
                ...
                if (action == MotionEvent.ACTION_DOWN) {
                    ...
                    GetLocation location = new GetLocation(BuyerRegisterationActivityGuest.this);
...
//                        new BuyerRegisterationGuest(BuyerRegisterationActivityGuest.this, BuyerRegisterationActivityGuest.this, requestModel);
//                    } else {
//                        Toast.makeText(BuyerRegisterationActivityGuest.this, "Please Enter the Values first", Toast.LENGTH_SHORT).show();
//                    }
...
//            paramName.addRule(RelativeLayout.BELOW, below.getId());
    ...
    public void transation() {
        Intent sellerDeshBoard = new Intent(BuyerRegisterationActivityGuest.this, SellerDeshBoardActivity.class);
    ...
    public void onRegistrationCompleted(ArrayList<RegisterModel> list) {
        ...
        new UpdateDeviceInfoService(BuyerRegisterationActivityGuest.this, "buyer", globels.getGlobelRef().buyerLoginId, globels.getGlobelRef().deviceToken);
        Constant.logInAs = "customeLogin";
        //startActivity(new Intent(BuyerRegisterationActivityGuest.this, HomeActivity.class));
        //////////////
