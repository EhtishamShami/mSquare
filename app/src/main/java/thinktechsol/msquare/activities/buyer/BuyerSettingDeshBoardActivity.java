...
public class BuyerSettingDeshBoardActivity extends Activity {
...
//    Products selectedProduct;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buyer_deshboard_setting);
...
//                new AddToWishListBuyerService(BuyerSettingDeshBoardActivity.this, BuyerSettingDeshBoardActivity.this, requestModel);
//
//            }
//        });
...
//        adapter = new ImgSwiperAdapterProDetailBuyer(BuyerSettingDeshBoardActivity.this,
...
//        BuyerProReviewsAdapter adapter = new BuyerProReviewsAdapter(this, BuyerSettingDeshBoardActivity.this, R.layout.buyer_pro_review_list_item, reviews_list);
//        pro_reviews_list.setAdapter(adapter);
        ...
        logoutText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new UpdateDeviceInfoService(BuyerSettingDeshBoardActivity.this, "buyer", globels.getGlobelRef().sellerLoginId, globels.getGlobelRef().deviceToken);
